...
# Your code here
#import collections 
#word_freq2 = dict(collections.OrderedDict(sorted(word_freq.keys())))
keys = list(word_freq.keys())
keys.sort()
#print(keys)
word_freq2 = {i:word_freq[i] for i in keys }
print(word_freq2)
...
sorted_tups = sorted(word_freq.items(), key = operator.itemgetter(1))
#print(sorted_tups)
word_freq2 = {i[0]:i[-1] for i in sorted_tups}
print(word_freq2)
...
# Your code here
df = pd.DataFrame()
df['word'] = word_freq.keys()
df['freq'] = word_freq.values()
print(df)
